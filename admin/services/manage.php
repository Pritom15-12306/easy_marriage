...
<div class="card card-outline card-info">
    <div class="card-header">
        <h3 class="card-title"><?php echo isset($id) ? "Update " : "Create New " ?>Services</h3>
    </div>
    <div class="card-body">
        <form action="" id="services-form">
            <input type="hidden" name="id" value="<?php echo isset($id) ? $id : '' ?>">
            <div class="form-group">
                <label for="title" class="control-label">Services Title</label>
                <textarea name="title" id="" cols="30" rows="2" class="form-control form no-resize"><?php echo isset($title) ? $title : ''; ?></textarea>
            </div>
            <div class="form-group">
                <label for="tour_location" class="control-label">Service Short Descriptopn</label>
    ...
    <div class="card-footer">
        <button class="btn btn-flat btn-primary" form="services-form">Save</button>
...
<script>
    ...
    $(document).ready(function() {
        ...
        $('#services-form').submit(function(e) {
            ...
            start_loader();
            $.ajax({
                url: _base_url_ + "classes/Master.php?f=save_services",
