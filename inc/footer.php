...
<script type="text/javascript">
  ...
  (function() {
    ...
    s1.async = true;
    s1.src = 'https://embed.tawk.to/63a82ef9474251287909fc48/1gl4ff064';
    s1.charset = 'UTF-8';
...
<footer class="footer py-4 ">
  <div class="container">
    <div class="row align-items-center">
      <div class="col-lg-4 text-lg-start">Copyright &copy; All Rights Reserved Easy Marriage</div>
      <div class="col-lg-4 my-3 my-lg-0">
        <a class="btn btn-dark btn-social mx-2" href="https://www.instagram.com/" target="_blank"><i class="fab fa-instagram"></i></a>
      ...
      <div class="col-lg-4 text-lg-end">
        ...
        <span>Developed By: Easy Marriage Team</a></span>
      </div>
    </div>
  </div>
</footer>
